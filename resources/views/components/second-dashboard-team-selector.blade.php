<section>
    ...
    <div id="dashboard-team-selector-dropdown"
        class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow-xl w-52 dark:bg-gray-900 dark:divide-gray-900 ring-1 ring-black ring-opacity-5 dark:ring-gray-700">
